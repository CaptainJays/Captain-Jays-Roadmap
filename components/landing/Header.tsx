  ...
  return (
    <header className="relative flex justify-center">
      <div className="z-1 flex w-full items-center justify-between gap-2 px-2 sm:px-8">
        ...
        <NextLink
          href="/"
          className="focus-visible group flex h-14 w-14 flex-col items-center gap-1 rounded-b-3xl bg-secondary/30 px-[6px] pt-2 text-xl transition-colors hover:bg-primary/25 dark:bg-card dark:hover:bg-border/70 sm:size-32 sm:rounded-b-4xl sm:pt-4 sm:text-xl lg:w-36 lg:text-2xl"
          title="Captain Jays RoadMap app"
        >
          <LogoSVG className="w-[1.5em] group-hover:animate-bounce" />
          <span className="font-display -tracking-widest max-sm:sr-only">CJ Roadmap</span>
        </NextLink>
